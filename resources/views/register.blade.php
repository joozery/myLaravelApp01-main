            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-md-6 left-section">
                        ...
                        <p>"ระบบจัดการอู่ SITTHA GARAGE เป็นโซลูชันที่ออกแบบมาเพื่อช่วยให้เจ้าของอู่และช่างสามารถบริหารจัดการงานซ่อมและควบคุมสต็อกอะไหล่ได้อย่างมีประสิทธิภาพ"</p>
                    </div>
                    ...
                    <div class="col-md-6 right-section">
                        ...
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <!-- ชื่อ -->
                            <div class="mb-3">
                                <input type="text" class="form-control" id="name" name="name" placeholder="ชื่อและนามสกุล" required>
                            </div>
